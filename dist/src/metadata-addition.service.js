...
const { createAndMint, TokenStandard, mplTokenMetadata } = mplTokenMetadataExports;
...
function findAssociatedTokenPda(_umi, { mint, owner }) {
...
function getUmiSigner(umi) {
    ...
    const secretKey = web3JsKeypair.secretKey;
