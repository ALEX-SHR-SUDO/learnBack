// src/token.routes.ts
import express from "express"; // Импортируем типы для Express
const router = express.Router();
// ✅ ИМПОРТ ФУНКЦИЙ КОНТРОЛЛЕРА
import { handleCreateTokenAndMetadata, handleAddTokenMetadata } from "./metadata-addition.controller.js";
